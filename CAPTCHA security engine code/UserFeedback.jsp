...
<%			String usernamesession=(String)session.getAttribute("usernamesession");%>
			...
			<form action="UserFeedback.jsp" method="post">
				<table border="2">
				<tr><th>Enter your Comments</th>
				<td><textarea rows=10 cols=20 name="message">
</textarea></td></tr>
				</table>                         
...
ResultSet rs=null; 	
	...
	con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","captcha","captcha");
			...
			int n=st.executeUpdate("insert into feedback values('"+usernamesession+"','"+message+"') ");
			if(n>0)
			{
